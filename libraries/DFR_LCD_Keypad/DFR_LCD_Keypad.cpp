...
// Added by Neo Ayestaran in order to return the corresponding decimal kepad ADC values
// to allow for recalibration of the define list in DFR_LCD_Keypad.h (lines 38-49).
int DFR_LCD_Keypad::read_key_value(void)
{
	int adcval = analogRead(_key_pin);
	return adcval;
}
// --------------------------------------------------------------
